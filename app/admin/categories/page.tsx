...
import {
    ...
    Bike, Car, Plane, Music, Film, Palette, Calculator,
    Utensils, Armchair, Dumbbell, Dog, Flower2,
...
const iconOptions = [
    ...
    { name: 'zap', icon: Zap, label: 'Elektrik & El Aletleri' },
    { name: 'tool', icon: Hammer, label: 'Hırdavat' },
    { name: 'heart', icon: Heart, label: 'Kalp' },
    { name: 'shirt', icon: Shirt, label: 'Giyim' },
    { name: 'home', icon: Home, label: 'Ev & Yaşam' },
    { name: 'furniture', icon: Armchair, label: 'Mobilya' },
    ...
    { name: 'kitchen', icon: Utensils, label: 'Mutfak' },
    { name: 'book', icon: Book, label: 'Kitap' },
    { name: 'bike', icon: Bike, label: 'Bisiklet' },
    { name: 'car', icon: Car, label: 'Otomotiv' },
    { name: 'plane', icon: Plane, label: 'Seyahat' },
    { name: 'music', icon: Music, label: 'Müzik' },
    { name: 'film', icon: Film, label: 'Film' },
    { name: 'palette', icon: Palette, label: 'Sanat & Hobi' },
    { name: 'office', icon: Briefcase, label: 'Ofis' },
    { name: 'baby', icon: Baby, label: 'Anne & Bebek' },
    { name: 'sport', icon: Dumbbell, label: 'Spor' },
    { name: 'pet', icon: Dog, label: 'Evcil Hayvan' },
    { name: 'garden', icon: Flower2, label: 'Bahçe' },
    { name: 'beauty', icon: Scissors, label: 'Güzellik' },
    { name: 'sea', icon: Anchor, label: 'Deniz' },
    { name: 'sun', icon: Sun, label: 'Yaz' },
    { name: 'moon', icon: Moon, label: 'Gece' },
    { name: 'weather', icon: Cloud, label: 'Hava' },
    { name: 'umbrella', icon: Umbrella, label: 'Şemsiye' },
    { name: 'security', icon: Lock, label: 'Güvenlik' },
